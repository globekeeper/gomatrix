...
func (cli *Client) PostThreePID(req ReqPostThreePID) (err error) {
	u := cli.BuildURL("account", "3pid")
	err = cli.MakeRequest(http.MethodPost, u, req, nil)
	return
}
...
func (cli *Client) Members(roomId string) (resp RespMembers, err error) {
